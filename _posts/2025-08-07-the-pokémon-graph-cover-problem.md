...
- **Which attack types can I choose to be effective against every defensive type I will encounter in the game? Each of the six Pokémon in a team can learn four attacks so that is 24 attack slots available (more than we need as there are at most 18 attack types to select from in any generation). Again, considering the entire game versus some smaller sections will change the range of defensive types you will see, but the question remains the same.**
