...
To jump right in to the demo check out the [web app demo powered by raylib and Emscripten](https://agl-alexglopez.github.io/dancing-links-and-planning-pokemon/) (for correct mouse tracking enable full screen). Or, visit the repository to build the desktop app locally.
